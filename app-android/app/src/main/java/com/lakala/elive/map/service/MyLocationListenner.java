...
public class MyLocationListenner implements BDLocationListener, OrientationUtil.OnOrientationListener {
    ...
    public void onReceiveLocation(BDLocation location) {
        ...
        if(mReceiverLoca!=null&&ll!=null)mReceiverLoca.onReceiver(ll);
    }
    ...
    public interface ReceiverLoca{
        public void onReceiver(LatLng latLng);
    }
    private ReceiverLoca mReceiverLoca;

    public void setmReceiverLoca(ReceiverLoca mReceiverLoca) {
        this.mReceiverLoca = mReceiverLoca;
    }
}
