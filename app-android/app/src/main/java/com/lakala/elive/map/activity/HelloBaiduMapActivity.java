...
public class HelloBaiduMapActivity extends BaseActivity {
    ...
    private final static String TAG = "HelloBaiduMapActivity";
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        switch (keyCode) {
            ...
            case KeyEvent.KEYCODE_3:
                ...
                MapStatus currentMapStatus = mBaiduMap.getMapStatus();    // 获取地图当前的状态
            ...
            case KeyEvent.KEYCODE_4:
                ...
                currentMapStatus = mBaiduMap.getMapStatus();    // 获取地图当前的状态
