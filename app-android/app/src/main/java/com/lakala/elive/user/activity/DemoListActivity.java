...
import com.lakala.elive.camera.activity.CameraActivity;
import com.lakala.elive.map.activity.HelloBaiduMapActivity;
...
public class DemoListActivity extends ListActivity {
    ...
    private ClassAndName[] datas = {
            new ClassAndName(HelloBaiduMapActivity.class, "HelloBaiduMapActivity"),
...
//			new ClassAndName(WalkingSearchActivity.class, "步行路线搜索"),
            ...
            new ClassAndName(CameraActivity.class, "上传图片")
    };
