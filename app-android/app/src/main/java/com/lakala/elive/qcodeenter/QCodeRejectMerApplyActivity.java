...
public class QCodeRejectMerApplyActivity extends BaseActivity implements DataCallBack {

    private TextView tvIdDate, tvProvince, tvCity, tvCounty,
//            tvArea,
            tvBigClass, tvCentreClass, tvSmallClass, tvBizContent, tvScanCardNumber;
...
//    private String businessArea;//营业面积
    ...
    protected void setContentViewId() {
        setContentView(R.layout.activity_qcode_reject_merapply);
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.tv_centre_class://商户类别
                if (centreClassList == null || centreClassList.size() == 0) {
                    ...
                    Toast.makeText(QCodeRejectMerApplyActivity.this, "请选择商户类型！", Toast.LENGTH_SHORT).show();
                    break;
                }
            ...
            case R.id.tv_city:// 市
                if(TextUtils.isEmpty(tvProvince.getText().toString())){
                    Toast.makeText(QCodeRejectMerApplyActivity.this, "请先选择省！", Toast.LENGTH_SHORT).show();
                    cityList.clear();
                    break;
                }
                if (cityList == null || cityList.size() == 0) {
                    cityList = new ArrayList<String>();
                    Toast.makeText(QCodeRejectMerApplyActivity.this, "请选择省！", Toast.LENGTH_SHORT).show();
                    break;
                }
            ...
            case R.id.tv_county:// 县
                ...
                if(TextUtils.isEmpty(tvCity.getText().toString())){
                    Toast.makeText(QCodeRejectMerApplyActivity.this, "请先选择市！", Toast.LENGTH_SHORT).show();
                    countyList.clear();
                    break;
                }
                if (countyList == null || countyList.size() == 0) {
                    countyList = new ArrayList<String>();
                    Toast.makeText(QCodeRejectMerApplyActivity.this, "请重新选择省！", Toast.LENGTH_SHORT).show();
                    break;
                }
    ...
    private boolean checkParams(){
        ...
        */
        if(TextUtils.isEmpty(email)){
            Utils.showToast(QCodeRejectMerApplyActivity.this, "请输入邮箱地址");
            return false;
        }
        if(!email.matches("^[a-zA-Z0-9_-]+@[a-zA-Z0-9_-]+(\\.[a-zA-Z0-9_-]+)+$")){
            Utils.showToast(QCodeRejectMerApplyActivity.this, "请输入正确邮箱地址");
            return false;
        }
        return true;
    }
...
//                break;
    ...
    private boolean isOverdue(String time) {
        ...
        try {
            ...
            e.printStackTrace();
            Utils.showToast(QCodeRejectMerApplyActivity.this, "时间格式不对");
            return true;
        }
    ...
    OptionsPickerView.OnOptionsSelectListener provinceSelectListener = new OptionsPickerView.OnOptionsSelectListener() {
        ...
        public void onOptionsSelect(int options1, int option2, int options3) {
            ...
            NetAPI.merDictionaryReq(QCodeRejectMerApplyActivity.this, QCodeRejectMerApplyActivity.this, regionReq, NetAPI.BMCP_REGION_REQUEST);
...
//            List<MerDictionaryResp.ContentBean.ItemsBean> mccs = bmcpMccBigClassResp.getItems();
            ...
            NetAPI.merDictionaryReq(QCodeRejectMerApplyActivity.this, QCodeRejectMerApplyActivity.this, mccReq, NetAPI.BMCP_MCC_REQUEST);
        }
    };
