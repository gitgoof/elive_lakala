...
public class ChinaAndCharEdtText extends EditText {
    public ChinaAndCharEdtText(Context context) {
        super(context);
    }

    public ChinaAndCharEdtText(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ChinaAndCharEdtText(Context context, AttributeSet attrs, int defStyleAttr) {
