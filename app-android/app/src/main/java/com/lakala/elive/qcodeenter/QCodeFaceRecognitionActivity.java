...
public class QCodeFaceRecognitionActivity extends BaseActivity {

    private ImageView imgProgress;
    private TextView edtName, edtIdNumber;
    ...
    protected void bindView() {
        ...
        EliveApplication.setImageQCodeProgress(imgProgress, 3, EliveApplication.PUBLICQCODE);
    }
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_next:
                if (accountKind.equals(EnterPieceActivity.PUBLIC_ACCOUNT)) {//对公
                    startActivity(new Intent(this, QCodeCompanyInfoActivity.class)
                    ...
                    startActivity(new Intent(this, QCodeSupplemeProveActivity.class)
                                    .putExtra(APPLY_ID, applyId)
                                    .putExtra(ID, id)
                                    .putExtra(EnterPieceActivity.MERCHANT_ID, merchantId)
//                            .putExtra("ContentBean", contentBean)
    ...
    private void startRecognition() {
        ...
        Intent i = new Intent(QCodeFaceRecognitionActivity.this, SampleLivenessActivity.class);
