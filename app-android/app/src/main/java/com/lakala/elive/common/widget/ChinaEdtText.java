...
public class ChinaEdtText extends EditText {
    public ChinaEdtText(Context context) {
        super(context);
    }

    public ChinaEdtText(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ChinaEdtText(Context context, AttributeSet attrs, int defStyleAttr) {
