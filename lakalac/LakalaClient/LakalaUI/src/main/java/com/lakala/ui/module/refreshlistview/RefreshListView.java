...
public class RefreshListView extends ListView implements OnScrollListener {
	...
	private void invokeOnScrolling() {
		if (mScrollListener instanceof OnRefreshListViewScrollListener) {
            OnRefreshListViewScrollListener l = (OnRefreshListViewScrollListener) mScrollListener;
			l.onScrolling(this);
		}
	}
...
//		setSelection(mTotalItemCount - 1); // scroll to bottom
	 ...
	 */
	public interface OnRefreshListViewScrollListener extends OnScrollListener {
