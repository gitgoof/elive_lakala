...
//						toast.show();
						ToastUtil.toast(context,R.string.ui_email_error);
					}
				}
			}
		});
	...
	protected void replaceText(CharSequence text) {
		...
		LogUtil.i(TAG + " replaceText", text.toString());
	...
	protected void performFiltering(CharSequence text, int keyCode) {
		...
		LogUtil.i(TAG + " performFiltering", text.toString() + "   " + keyCode);
	...
	private class EmailAutoCompleteAdapter extends ArrayAdapter<String> {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			LogUtil.i(TAG, tv.getText().toString());
			return v;
		}
	}
}
