		...
		if (isShowRightSelectImg){
            ...
            if (position == selectposition) {
                if (rightDrawableId!=0){
                    ...
                    holder.item.setRightIconDrawable(mContext.getResources().getDrawable(R.drawable.ui_check_on));
                }
            }else {
                if (isOnlyShowSelectedImage){
                    ...
                    if (rightDrawableId !=0){
                        ...
                        holder.item.setRightIconDrawable(mContext.getResources().getDrawable(R.drawable.ui_check_off));
                    }
                }
            }
        }else {
