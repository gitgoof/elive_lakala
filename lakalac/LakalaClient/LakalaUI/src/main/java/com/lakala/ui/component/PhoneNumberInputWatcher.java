...
public class PhoneNumberInputWatcher implements TextWatcher{
    ...
    private CallBackPhoneInterface cbPhone;
    public PhoneNumberInputWatcher() {
    }

    public PhoneNumberInputWatcher(CallBackPhoneInterface cbPhone) {
    ...
    public void afterTextChanged(Editable text) {
        ...
        if(cbPhone != null){
            cbPhone.callBackPhone(text.toString(), text.toString().length());
        }
    }
     ...
     * 输入完手机号后进行回调
     */
    public interface CallBackPhoneInterface{

        void callBackPhone(String text, int length);

        /**
         * 各项均输入合法
         */
//        void inputValidCallBack();

        /**
         * 输入不合法
         */
//        void inputInvalidCallBack();
    }
