...
import com.lakala.platform.activity.BasePaymentActivity3;
 ...
 */
public abstract class CommonPayment3Activity extends BasePaymentActivity3 implements ServiceResultCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_common_payment2);
        initUI();
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (progressDialog == null) {
                    progressDialog = DialogCreator.createDialogWithNoMessage(CommonPayment3Activity.this);
                }
                progressDialog.show();
            }
        });
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (baseTransInfo.isSignatureNeeded()) {
                    //是否需要电子签名
                    intent.setClass(CommonPayment3Activity.this, BillSignatureActivity.class);
                } else {
                    intent.setClass(CommonPayment3Activity.this, ConfirmResultActivity.class);
                }
...
//            showMsg("成功");
            ...
            //受理超时, 支付超时
            showMsg("交易超时");
            LogUtil.print("<S>","交易超时");
            baseTransInfo.setTransResult(TransResult.TIMEOUT);

        }else{
            showMsg(resultServices.retMsg);
            LogUtil.print("<S>","失败");
...
//        LogUtil.print("<S>","handleTransResult："+baseTransInfo.getCardType());
//        LogUtil.print("<S>","handleTransResult："+SwiperInfo.CardType.ICCard);
