...
public class PrivilegePurchaseTransInfo2 extends BaseTransInfo{
    ...
    public String getAmount() {
		...
		double ad=dAmount/100;
		String amo=df.format(ad);
        return amo;
    }
...
//		this.busstype = uri.getQueryParameter("busstype");
	...
	public List<TransferInfoEntity> getConfirmInfo() {
        ...
        transferInfoEntities.add(new TransferInfoEntity("商品名称:", getOrderInfo()));
...
//        transferInfoEntities.add(new TransferInfoEntity("刷卡金额:", Util.formatDisplayAmount(getSwipeAmount()), true));
		transferInfoEntities.add(new TransferInfoEntity("刷卡金额:", amo+"元", true));
...
//		infoEntities.add(new TransferInfoEntity("交易金额:", Util.formatDisplayAmount(getSwipeAmount()),true));
		infoEntities.add(new TransferInfoEntity("交易金额:", df.format(ad)+"元",true));
...
//		 setMercid(jb.optString("mercid"));
		 setOrderNo(jb.optString("orderId"));
		 setAmount(jb.optString("amount"));
		 setFee(jb.optString("fee", ""));
		 setPayType(jb.optString("payType"));
		 setOrderInfo(jb.optString("orderInfo"));
