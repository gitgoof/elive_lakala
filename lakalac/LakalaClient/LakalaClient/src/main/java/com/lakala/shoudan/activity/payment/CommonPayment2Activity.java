...
import com.lakala.platform.activity.BasePaymentActivity2;
 ...
 */
public abstract class CommonPayment2Activity extends BasePaymentActivity2 implements ServiceResultCallback{
    ...
    protected String icc55="";

    protected PrivilegePurchaseTransInfo2 baseTransInfo;
    boolean isOk=false;
...
////        super.onNotifyFinish(error);
//        LogUtil.print("<AS>","finish");
//        if(!isOk){
//            finish();
//        }else {
//            isOk=false;
//            requestUploadTc(swiperManagerHandler.getSwiperInfo());
//        }
//    }
    ...
    protected void initUI(){
        ...
        baseTransInfo = (PrivilegePurchaseTransInfo2)getIntent().getSerializableExtra(ConstKey.TRANS_INFO);
        ...
        swiperManagerHandler.setAmount(baseTransInfo.getAmount());
...
//        TimeCounter.getInstance().save2BackgroundTime(this);
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (progressDialog == null) {
                    progressDialog = DialogCreator.createDialogWithNoMessage(CommonPayment2Activity.this);
                }
                progressDialog.show();
            }
        });
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                if (baseTransInfo.isSignatureNeeded()) {
                    //是否需要电子签名
                    intent.setClass(CommonPayment2Activity.this, BillSignatureActivity.class);
                } else {
                    intent.setClass(CommonPayment2Activity.this, ConfirmResultActivity.class);
                }
    ...
    protected void startSwipe(){
        ...
        final String amount = baseTransInfo.getAmount();
...
//                updatePrompt("蓝牙搜索结束");
    ...
    protected void onExecuteSuccess(ResultServices resultServices){
        ...
        if(resultServices.isRetCodeSuccess()){
            ...
            //受理超时, 支付超时
            LogUtil.print("<AS>","失败1");
            baseTransInfo.setTransResult(TransResult.TIMEOUT);
        }else{
            LogUtil.print("<AS>","失败2");
