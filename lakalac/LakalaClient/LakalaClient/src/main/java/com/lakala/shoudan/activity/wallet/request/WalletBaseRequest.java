 ...
 */
public class WalletBaseRequest implements Serializable {
    ...
    public WalletBaseRequest setTelecode(String telecode) {
        this.telecode = telecode;
        return this;
    }

    public WalletBaseRequest(Context context) {
    ...
    public WalletBaseRequest setPlatform(String platform) {
    ...
    public WalletBaseRequest setTimeStamp(String timeStamp) {
    ...
    public WalletBaseRequest setGesturePwd(String gesturePwd) {
    ...
    public WalletBaseRequest setGuid(String guid) {
        this.guid = guid;
        return this;
    }
    ...
    public WalletBaseRequest setDeviceId(String deviceId) {
        this.deviceId = deviceId;
        return this;
    }
    ...
    public WalletBaseRequest setDeviceModel(String deviceModel) {
    ...
    public WalletBaseRequest setSubChannelId(String subChannelId) {
    ...
    public WalletBaseRequest setAccessToken(String accessToken) {
    ...
    public WalletBaseRequest setRefreshToken(String refreshToken) {
