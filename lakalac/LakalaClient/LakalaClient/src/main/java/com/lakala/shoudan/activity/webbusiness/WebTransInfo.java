 ...
 */
public class WebTransInfo extends BaseTransInfo {

    private String transTitle;
    private String tdtm;

    public WebTransInfo setTransTitle(String transTitle) {
    ...
    public String getStatisticTransResult() {
        return ShoudanStatisticManager.Promotion_Privilege_Purchase_Success;
    }
...
//	}
    ...
    public void setOrder(JSONObject jb){
//		 {"amount":"399.00","tdtm":"20150527143319","mercid":"3I100000601","ordno":"T20150527143319993","ordexpdat":"20150527150319","ordtime":"20150527143319","productName":"拉卡拉手机收款宝 ME30S","busid":"1CN","mobile":"13400531556","msgdigest":"70e6407dee1c51a0234f2cb8f49dbc497cd99a23"}
    ...
    public TransactionType getType() {
        TransactionType.PRIVILEGEPURCHASE.setValue(getTransTitle());
