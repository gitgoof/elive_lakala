 ...
 */
public abstract class NewCommandProtocolPayment2Activity extends CommonPayment2Activity{
    ...
    private void requestForSRandom(){
        ...
        BusinessRequest sRndRequest = BusinessRequest.obtainRequest(NewCommandProtocolPayment2Activity.this, "v1.0/token/btoken", HttpRequest.RequestMethod.POST, true);
...
//        inAccount	转入账号/手机号/商户号
    ...
    protected BusinessRequest createDefaultTradeRequest(){
        BusinessRequest businessRequest = BusinessRequest.obtainRequest(NewCommandProtocolPayment2Activity.this, "v1.0/business/marketzone/trade", HttpRequest.RequestMethod.POST, true);
...
//        requestParams.put("track1", swiperInfo.getTrack1());
        ...
        if(swiperInfo.getCardType()==SwiperInfo.CardType.ICCard){
            ...
            icc55=swiperInfo.getIcc55();
            LogUtil.print("<AS>","icc55:up="+swiperInfo.getIcc55());
        }else {
            requestParams.put("posemc", "0");
