 ...
 */
public abstract class NewCommandProtocolPaymentActivity extends CommonPaymentActivity{
    ...
    private void requestForSRandom(){
        ...
        BusinessRequest sRndRequest = BusinessRequest.obtainRequest(NewCommandProtocolPaymentActivity.this, "v1.0/token/btoken", HttpRequest.RequestMethod.POST, true);
...
//        inAccount	转入账号/手机号/商户号
    ...
    protected BusinessRequest createDefaultTradeRequest(){
        BusinessRequest businessRequest = BusinessRequest.obtainRequest(NewCommandProtocolPaymentActivity.this, "v1.0/trade", HttpRequest.RequestMethod.POST, true);
