 ...
 */
public abstract class NewCommandProtocolPayment3Activity extends CommonPayment3Activity{
    ...
    private void requestForSRandom(){
        ...
        LogUtil.print("<S>","requestForSRandom");
        BusinessRequest sRndRequest = BusinessRequest.obtainRequest(NewCommandProtocolPayment3Activity.this, "v1.0/token/btoken", HttpRequest.RequestMethod.POST, true);
...
//        inAccount	转入账号/手机号/商户号
    ...
    protected BusinessRequest createDefaultTradeRequest(){
        BusinessRequest businessRequest = BusinessRequest.obtainRequest(NewCommandProtocolPayment3Activity.this, "v1.0/trade", HttpRequest.RequestMethod.POST, true);
    ...
    protected void startPayment(SwiperInfo swiperInfo){
        ...
        LogUtil.print("<S>",businessRequest.getRequestParams().toString()+"");
    }
