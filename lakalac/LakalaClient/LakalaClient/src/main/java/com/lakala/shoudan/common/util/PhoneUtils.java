...
public class PhoneUtils {
    ...
    static {
        telephonyManager = (TelephonyManager) ApplicationEx
	...
	public static String getIMEI() {
		TelephonyManager manager = (TelephonyManager) ApplicationEx
				.getInstance().getSystemService(Context.TELEPHONY_SERVICE);
	...
	public static boolean isNetworkAvailable() {
		ConnectivityManager connectivity = (ConnectivityManager) ApplicationEx
	...
	public static String getNetworkStat() {
		...
		try {
			ConnectivityManager connMgr = (ConnectivityManager) ApplicationEx
	...
	public static boolean isGpsAvaiable() {
		LocationManager locationManager = (LocationManager) ApplicationEx
