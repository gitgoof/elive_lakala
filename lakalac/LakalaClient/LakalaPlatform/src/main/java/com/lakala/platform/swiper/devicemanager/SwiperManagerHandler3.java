 ...
 */
public class SwiperManagerHandler3 implements SwiperManagerListener {
    private final String TAG = SwiperManagerHandler3.class.getSimpleName();
    /**
    ...
    public SwiperManagerHandler3(Context context) {
    ...
    private ConnectionStateListener listener = new ConnectionStateListener() {
        ...
        public void onSwiperTypeValidate() {
            swiperManager = SwiperManager.getInstance(SwiperManagerHandler3.this);
        }
        ...
        public void onConnectionState(SwiperProcessState state) {
            ...
            if(state == SwiperProcessState.SIGN_UP_SUCCESS){
                swiperManager = SwiperManager.getInstance(SwiperManagerHandler3.this);
                swiperManager.setListener(SwiperManagerHandler3.this);
            }
        }
    };

    public SwiperManagerHandler3(Context context, Class<? extends BaseConnectionManager>  connection){
