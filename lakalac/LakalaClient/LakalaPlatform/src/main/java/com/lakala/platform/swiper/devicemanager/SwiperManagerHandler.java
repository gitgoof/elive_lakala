...
public class SwiperManagerHandler implements SwiperManagerListener {
    ...
    private ConnectionStateListener listener = new ConnectionStateListener() {
        ...
        public void onSwiperTypeValidate() {
            swiperManager = SwiperManager.getInstance(SwiperManagerHandler.this);
        }
        ...
        public void onConnectionState(SwiperProcessState state) {
            ...
            if(state == SwiperProcessState.SIGN_UP_SUCCESS){
                swiperManager = SwiperManager.getInstance(SwiperManagerHandler.this);
                swiperManager.setListener(SwiperManagerHandler.this);
            }
        }
    };

    public SwiperManagerHandler(Context context, Class<? extends BaseConnectionManager>  connection){
    ...
    public void onEmvFinished(boolean b, ICCardInfo cardInfo) {
        ...
        swiperInfo.setTcIcc55(com.lakala.core.swiper.ICFieldConstructor.createTcicc55(cardInfo.getEmvTransInfo()));
