...
import com.lakala.platform.swiper.devicemanager.SwiperManagerHandler3;
 ...
 */
public abstract class BasePaymentActivity3 extends BaseActionBarActivity implements SwiperManagerCallback{

    protected SwiperManagerHandler3 swiperManagerHandler;
    ...
    public void initSwiper() {
        //界面初始化完成,监听刷卡器
        swiperManagerHandler = new SwiperManagerHandler3(this, MultiConnectionManager.class);
    ...
    public void onMscProcessEnd(final SwiperInfo swiperInfo) {
        LogUtil.print("<S>","onMscProcessEnd");
