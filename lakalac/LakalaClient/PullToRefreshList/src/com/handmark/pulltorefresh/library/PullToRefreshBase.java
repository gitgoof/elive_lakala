...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
	...
	public final void setRefreshing(boolean doScroll,boolean showHeader){
		if(!isRefreshing()){
			setState(State.MANUAL_REFRESHING,doScroll,showHeader);
		}
	}
		...
		switch (mState) {
			...
			case MANUAL_REFRESHING:
				if(params.length == 1){
					...
					onRefreshing(params[0],params[1]);
				}
				break;
			case OVERSCROLLING:
				// NO-OP
	...
	protected void onRefreshing(final boolean doScroll,boolean showHeader){
