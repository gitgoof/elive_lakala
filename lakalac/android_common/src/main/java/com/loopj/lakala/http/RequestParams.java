 ...
 * {@link com.loopj.lakala.http.AsyncHttpClient} instance. <p>&nbsp;</p> For example: <p>&nbsp;</p>
 * <pre>
...
public class RequestParams {
    ...
    public String toString() {
        ...
        for (ConcurrentHashMap.Entry<String, StreamWrapper> entry : streamParams.entrySet()) {
            try {
                jsonObject.put(entry.getKey(),"STREAM");
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
        ...
        for (ConcurrentHashMap.Entry<String, FileWrapper> entry : fileParams.entrySet()) {
            try {
                jsonObject.put(entry.getKey(),"FILE");
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
    ...
    private HttpEntity createFormEntity() {
        try {
            ...
            LogUtil.e(LOG_TAG, "createFormEntity failed", e);
    ...
    public List<BasicNameValuePair> getNameValuePairs(){
        ...
        Set<String> paramsKeySet = urlParams.keySet();
