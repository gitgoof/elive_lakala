 ...
 * com.loopj.lakala.http.RequestParams} instance, and responses can be handled by passing an anonymously overridden {@link
 * com.loopj.lakala.http.ResponseHandlerInterface} instance. <p>&nbsp;</p> For example: <p>&nbsp;</p>
 * <pre>
...
public class AsyncHttpClient {
    ...
    public static final String DEFAULT_HEADER = "application/json";//For 商户通
    ...
    public static final String X_Device_Model = "X-Device-Model";//设备型号
    public static final String X_Device_Manufacture = "X-Device-Manufacture";//设备制造商
    public static final String  X_Tel_OP  = "X-Tel-OP";//IMSI 运营商
    public static final String X_Device_Name = "X-Device-Name";//设备名
    ...
    public static final int DEFAULT_SOCKET_TIMEOUT = BuildConfig.DEBUG ?100* 1000 :5 * 1000;
    public static final int DEFAULT_MAX_RETRIES = 5;
    public static final int DEFAULT_RETRY_SLEEP_TIME_MILLIS = 1500;
    public static final int DEFAULT_SOCKET_BUFFER_SIZE = 8192;

    public static final int DEFALUT_SO_TIMEOUT =BuildConfig.DEBUG ?200* 1000 : 25*1000;
...
//            sslSocketFactory = SSLSocketFactory.getSocketFactory();
        //使用自定义SocketFactory升级至TLSv1.2
        sslSocketFactory = MySSLSocketFactory.getFixedSocketFactory(context);
    ...
    public AsyncHttpClient(SchemeRegistry schemeRegistry) {
        ...
        HttpConnectionParams.setSoTimeout(httpParams, DEFALUT_SO_TIMEOUT);//数据请求超时
        ...
        //设置浏览器属性信息
        httpClient.getParams().setParameter(CoreProtocolPNames.USER_AGENT,"Lakala Android Client");
        ...
        httpClient.addRequestInterceptor(new HttpRequestInterceptor() {
            ...
            public void process(HttpRequest request, HttpContext context) {
                ...
                for (String header : clientHeaderMap.keySet()) {
                    ...
                    LogUtil.print("safa",header+":"+clientHeaderMap.get(header));
...
//                                  "" + header + " = " + clientHeaderMap.get(header));
     ...
     *                    com.loopj.lakala.http.PersistentCookieStore}
     */
     ...
     * @see com.loopj.lakala.http.MyRedirectHandler
     */
    ...
    public static void silentCloseOutputStream(OutputStream os) {
        try {
            ...
            LogUtil.w(LOG_TAG, "Cannot close output stream", e);
        }
    }
