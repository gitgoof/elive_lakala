...
/**
 * Used to intercept and handle the responses from requests made using {@link com.loopj.lakala.http.AsyncHttpClient}.
...
public abstract class BinaryHttpResponseHandler extends AsyncHttpResponseHandler {
    ...
    public BinaryHttpResponseHandler(String[] allowedContentTypes) {
        ...
        if (allowedContentTypes != null)
            ...
            LogUtil.e(LOG_TAG, "Constructor passed allowedContentTypes was null !");
    }
    ...
    public final void sendResponseMessage(HttpResponse response) throws IOException {
        ...
        for (String anAllowedContentType : getAllowedContentTypes()) {
            try {
                ...
                LogUtil.e("BinaryHttpResponseHandler", "Given pattern is not valid: " + anAllowedContentType, e);
            }
        }
