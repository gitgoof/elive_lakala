 ...
 */
public abstract class CordovaActivity extends LKLActionBarActivity implements CordovaInterface {
    ...
    private LinearLayoutSoftKeyboardDetect keyboardDetect;

    protected static final String MESSAGE_SPLASH_SCREEN;

    protected static final String MESSAGE_SPINNER;

    protected static final String MESSAGE_RECEIVED_ERROR;

    protected static final String MESSAGE_EXIT;

    protected static final String MESSAGE_SHOW_MENU;

    protected static final String SHOW_HTTP_ERROR_MSG;

    static {
        MESSAGE_SPLASH_SCREEN   = "splashscreen";
        MESSAGE_SPINNER         = "spinner";
        MESSAGE_RECEIVED_ERROR  = "onReceivedError";
        MESSAGE_EXIT            = "exit";
        MESSAGE_SHOW_MENU       = "showMenu";
        SHOW_HTTP_ERROR_MSG     = "showHttpErrorMsg";
    }
     ...
     * @return
     */
    protected abstract ViewGroup setRootView();
     ...
     * @param isCancel
     */
    protected abstract void showSpinner(final String title, final String message, boolean isCancel);

    /**
     * 停止遮罩
     */
    protected abstract void dismissSpinner();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        Config.init(this);
        LogUtil.d(TAG, "CordovaActivity.onCreate()");
...
//            getWindow().requestFeature(Window.FEATURE_NO_TITLE);
        ...
        if (this.getBooleanProperty("SetFullscreen", false)) {
            LogUtil.d(TAG, "The SetFullscreen configuration is deprecated in favor of Fullscreen, and will be removed in a future version.");
...
//                ViewGroup.LayoutParams.MATCH_PARENT, 0.0F));
    ...
    private void widgetInit() {
        ...
        keyboardDetect = new LinearLayoutSoftKeyboardDetect(this, appView, dm.widthPixels, dm.heightPixels);
    }
    ...
    public void init(CordovaWebView webView, CordovaWebViewClient webViewClient, CordovaChromeClient webChromeClient) {
        LogUtil.d(TAG, "CordovaActivity.init()");
...
//        this.root.setBackgroundColor(this.backgroundColor);
     ...
     * 加载html content
     *
     * @param baseUrl  baseUrl必须传值，如果传空值或者“about:blank”,会主动退出。
     * @param htmlContent html content
     */
    public void loadDataWithBaseURL(String baseUrl, String htmlContent) {
        this.keepRunning = this.getBooleanProperty("KeepRunning", true);
        ...
        //Load the correct splashscreen
        this.appView.loadDataWithBaseUrl(baseUrl, htmlContent, "text/html", HTTP.UTF_8, null);
    }
    ...
    void loadSpinner() {
        ...
        if (loading != null) {
            ...
            this.spinnerStart(title, message, false);
        }
    }
    ...
    public void setBooleanProperty(String name, boolean value) {
        LogUtil.d(TAG, "Setting boolean properties in CordovaActivity will be deprecated in 3.0 on July 2013, please use config.xml");
    ...
    public void setIntegerProperty(String name, int value) {
        LogUtil.d(TAG, "Setting integer properties in CordovaActivity will be deprecated in 3.0 on July 2013, please use config.xml");
        this.getIntent().putExtra(name.toLowerCase(), value);
    }
    ...
    public void setStringProperty(String name, String value) {
        LogUtil.d(TAG, "Setting string properties in CordovaActivity will be deprecated in 3.0 on July 2013, please use config.xml");
        this.getIntent().putExtra(name.toLowerCase(), value);
    }
    ...
    public void setDoubleProperty(String name, double value) {
        LogUtil.d(TAG, "Setting double properties in CordovaActivity will be deprecated in 3.0 on July 2013, please use config.xml");
        this.getIntent().putExtra(name.toLowerCase(), value);
    }
    ...
    protected void onPause() {
        ...
        LogUtil.d(TAG, "Paused the application!");
    ...
    protected void onResume() {
        ...
        LogUtil.d(TAG, "Resuming the App");


        //Code to test CB-3064
        String errorUrl = this.getStringProperty("ErrorUrl", null);
        LogUtil.d(TAG, "CB-3064: The errorUrl is " + errorUrl);
    ...
    public void onDestroy() {
        LogUtil.d(TAG, "CordovaActivity.onDestroy()");
        super.onDestroy();
     ...
     * <p/>
     * Add a class that implements a service.n
     */
    @Deprecated
     ...
     */
    public void spinnerStart(final String title, final String message, boolean isCancel) {
//        if (this.spinnerDialog != null) {
//            this.spinnerDialog.dismiss();
//            this.spinnerDialog = null;
//        }
//        this.spinnerDialog = DialogUtil.createProgressDialog(getSupportFragmentManager(), message);
//        this.spinnerDialog.show();
        showSpinner(title, message, isCancel);
    }
...
//        }
    ...
    public void startActivityForResult(CordovaPlugin command, Intent intent, int requestCode) {
        ...
        if (command != null) {
            //防止B2B 使跳转的activity进入pause状态 所以注视下面代码，不给让 keepRunning 为 false
...
//            Log.d(TAG, "result = " + filepath);
    ...
    public Context getContext() {
        LogUtil.d(TAG, "This will be deprecated December 2012");
        return this;
    }
...
//            return super.onKeyDown(keyCode, event);
    ...
    public Object onMessage(String id, Object data) {
        LogUtil.d(TAG, "onMessage(" + id + "," + data + ")");
        if (MESSAGE_SPLASH_SCREEN.equals(id)) {
        ...
        } else if (MESSAGE_SPINNER.equals(id)) {
            if ("stop".equals(data.toString())) {
                this.spinnerStop();
                this.appView.setVisibility(View.VISIBLE);
            }
        } else if (MESSAGE_RECEIVED_ERROR.equals(id)) {
        ...
        } else if (MESSAGE_EXIT.equals(id)) {
            this.endActivity();
        } else if (SHOW_HTTP_ERROR_MSG.equals(id)) {
            final CordovaActivity me = this;
            final Object message = data;
            this.runOnUiThread(new Runnable() {
                @Override
                public void run() {
                    ToastUtil.toast(me, message.toString());
                }
            });
        }
