...
public class NativeToJsMessageQueue {
    ...
    public void setBridgeMode(int value) {
        if (value < 0 || value >= registeredListeners.length) {
            LogUtil.d(LOG_TAG, "Invalid NativeToJsBridgeMode: " + value);
        } else {
            if (value != activeListenerIndex) {
                LogUtil.d(LOG_TAG, "Set native->JS mode to " + value);
                synchronized (this) {
    ...
    public void setPaused(boolean value) {
        if (paused && value) {
            ...
            LogUtil.e(LOG_TAG, "nested call to setPaused detected.", new Throwable());
        }
        paused = value;
        if (!value) {
            synchronized (this) {
    ...
    private class PrivateApiBridgeMode extends BridgeMode {
        ...
        private void initReflection() {
            ...
            try {
                ...
                initFailed = true;
                LogUtil.e(LOG_TAG, "PrivateApiBridgeMode failed to find the expected APIs.", e);
            }
        }
        ...
        @Override void onNativeToJsMessageAvailable() {
            ...
            if (sendMessageMethod != null) {
                ...
                try {
                    ...
                    LogUtil.e(LOG_TAG, "Reflection message bridge failed.", e);
                }
            }
        }
    }
