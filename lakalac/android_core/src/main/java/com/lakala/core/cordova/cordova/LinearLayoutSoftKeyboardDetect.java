...
//    private CordovaActivity app = null;
    ...
    public LinearLayoutSoftKeyboardDetect(Context context,CordovaWebView appView ,int width, int height) {
        super(context);
        screenWidth = width;
        screenHeight = height;
//        app = (CordovaActivity) context;
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        LogUtil.v(TAG, "We are in our onMeasure method");
        ...
        LogUtil.v(TAG, "Old Height = %d", oldHeight);
        LogUtil.v(TAG, "Height = %d", height);
        LogUtil.v(TAG, "Old Width = %d", oldWidth);
        LogUtil.v(TAG, "Width = %d", width);
        ...
        if (oldHeight == 0 || oldHeight == height) {
            LogUtil.d(TAG, "Ignore this event");
        }
        ...
        else if (screenHeight == width)
        {
            ...
            screenWidth = tmp_var;
            LogUtil.v(TAG, "Orientation Change");
        }
...
//                app.appView.sendJavascript("cordova.fireDocumentEvent('hidekeyboard');");
                appView.sendJavascript("cordova.fireDocumentEvent('hidekeyboard');");
        }
...
//                app.appView.sendJavascript("cordova.fireDocumentEvent('showkeyboard');");
                appView.sendJavascript("cordova.fireDocumentEvent('showkeyboard');");
        }
