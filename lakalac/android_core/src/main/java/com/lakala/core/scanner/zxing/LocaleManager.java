...
public final class LocaleManager {
  ...
  public static String getCountry(Context context) {
    ...
    String countryOverride = prefs.getString(Constact.KEY_SEARCH_COUNTRY, null);
    if (countryOverride != null && !TextUtils.isEmpty(countryOverride) && !"-".equals(countryOverride)) {
