...
import com.lakala.core.cordova.cordova.CordovaResourceApi.OpenForReadResult;
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, String url) {
        try {
            ...
            if ((url.startsWith("http:") || url.startsWith("https:")) && !Config.isUrlWhiteListed(url)) {
                LogUtil.w(TAG, "URL blocked by whitelist: " + url);
                // Results in a 404.
            ...
            if (!(e instanceof FileNotFoundException)) {
                LogUtil.e("IceCreamCordovaWebViewClient", "Error occurred while loading a file (returning a 404).", e);
            }
            // Results in a 404.
            return new WebResourceResponse("text/plain", "UTF-8", null);
        }
