...
public class Config {
    ...
    private Config(Activity action) {
        if (action == null) {
            LogUtil.i("CordovaLog", "There is no activity. Is this on the lock screen?");
            return;
        }
        ...
        if (id == 0) {
            ...
            if (id == 0) {
                LogUtil.i("CordovaLog", "config.xml missing. Ignoring...");
                return;
            }
        }
        ...
        while (eventType != XmlResourceParser.END_DOCUMENT) {
            if (eventType == XmlResourceParser.START_TAG) {
                ...
                if (strNode.equals("access")) {
                    ...
                    LogUtil.d(TAG, "The <log> tags is deprecated. Use <preference name=\"loglevel\" value=\"" + level + "\"/> instead.");
                    if (level != null) {
                    ...
                    LogUtil.i("CordovaLog", "Found start page location: %s", src);
...
//                            startUrl = "file:///android_asset/www/" + src;
                            startUrl = "file:///data/data/com.lakala.mobilebank/www/" + src;
                        }
                    }
                }
    ...
    public static String getStartUrl() {
        if (self == null || self.startUrl == null) {
            return "file:///data/data/com.lakala.android/www/android.html";
        }
