...
import com.lakala.core.scanner.zxing.Contents;
import com.lakala.core.scanner.zxing.LocaleManager;
...
public abstract class ResultHandler {
  ...
  final void openURL(String url) {
    ...
    try {
      ...
      LogUtil.w(TAG, "Nothing available to handle " + intent);
    }
  }
  ...
  final void rawLaunchIntent(Intent intent) {
    if (intent != null) {
      ...
      LogUtil.d(TAG, "Launching intent: " + intent + " with extras: " + intent.getExtras());
  ...
  private String parseCustomSearchURL() {
    ...
    String customProductSearch = prefs.getString(Constact.KEY_CUSTOM_PRODUCT_SEARCH,
        null);
