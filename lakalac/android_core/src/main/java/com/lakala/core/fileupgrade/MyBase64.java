...
/*package*/ class MyBase64 {
    ...
    public final static int[] alphabeta ={
    	0xB2A7,0x39CE,0xCF56,0x99D3,0xAB11,0xBD43,0xCF56,0xBB22
    };
    
    public final static int[] alphabetb = {
    	0x3EDC,0x43DC,0x980A,0xF561,0x2DEE,0xB9C6,0x5ABC,0x9087
    };
